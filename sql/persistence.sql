CREATE TABLE IF NOT EXISTS pekko_event_journal
(
    slice              INT          NOT NULL,
    ...
    INDEX pekko_event_journal_slice_idx (slice, entity_type, db_timestamp, seq_nr)
) ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS pekko_snapshot
(
    slice             INT          NOT NULL,
    entity_type       VARCHAR(255) NOT NULL,
